  ...
  return (
    <Card className="p-5">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          <h3 className="text-lg font-bold">老师审核单向阀</h3>
          <p className="mt-1 text-sm text-stone-500">未经老师审核，报告不会导出给家长。</p>
        </div>
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        <Button onClick={() => onStatusChange("teacher_reviewing")}>编辑</Button>
        <Button onClick={() => onStatusChange("rejected")}>退回</Button>
      ...
      <div className="mt-5">
        <h4 className="text-sm font-bold">审计记录</h4>
